...
class Stats extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            audio_source: "https://www.soundjay.com/phone/telephone-ring-03a.mp3",
        };
    }
    ...
    calculatePeople(input) {
        ...
        if (this.state.totalCount >= 4) {
            const audioE2 = document.getElementsByClassName("audio-element2")[0]
            audioE2.play()
        }
    }
        ...
        return (
            <div className={`stats ${this.props.statsOn ? "active" : ""}`}>
                ...
                <audio className="audio-element2">
                    <source src={this.state.audio_source}></source>
                </audio>
            </div>
        );
    }
